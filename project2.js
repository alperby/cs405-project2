...
class MeshDrawer {
	...
	constructor() {
		...
		this.reverseLightDirectionLocation = gl.getUniformLocation(this.prog, "u_reverseLightDirection");
	...
	draw(trans) {
		...
		gl.uniform3fv(this.reverseLightDirectionLocation, normalize([-lightX, -lightY, 5]));
	...
	setAmbientLight(ambient) {
		 ...
		 */
		gl.useProgram(this.prog);
		gl.uniform1i(this.ambientLightLoc, ambient);
	}
}
